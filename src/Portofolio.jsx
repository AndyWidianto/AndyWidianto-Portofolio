            ...
            <header>
                <nav>
                    <ul className="navbar-ul" style={activeNavbar ? { maxHeight: "250px" } : { maxHeight: "35px" }}>
                        ...
                        <li><a href="#skill" className="nav">Skill</a></li>
                        <li><a href="#project" className="nav">Project</a></li>
                        <li><a href="#sertifikat" className="nav">Sertifikat</a></li>
                        <li><a href="#contact" className="nav">Contact</a></li>
                        <li className="icon"><button onClick={() => setActiveNavbar(!activeNavbar)}><Menu className="icon-menu" /> </button></li>
                    </ul>
                </nav>
            </header>
            <main>
                <section id="home" className="home">
                    ...
                    {/* <!-- <div className="picture">
                        <img src="images/gambar_saya.jpg" alt="">
                    </div> */}
                </section>
                        ...
                        <div className="description">
                            <div className="text-about-me">
                                <p>
                                    ...
                                    yang masih dalam tahap pengembangan, dan web informasi kesehatan dengan fitur utama prediksi
                                    ...
                                    Karena itu, saya selalu terbuka untuk kesempatan magang, pekerjaan full-time, atau
                                    kolaborasi proyek bersama tim yang mendukung pertumbuhan teknologi.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <section id="skill" className="skill">
                    <h2 className="judul">My Skill</h2>
                    <div className="card">
